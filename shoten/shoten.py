...
def read_file(filepath: str, *, maxdiff: int=1000, mindiff: int=0, authorregex: Optional[Pattern[str]]=None, details: bool=True) -> Iterator[Tuple[str, int, Optional[str], bool]]:
